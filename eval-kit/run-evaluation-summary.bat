...
echo ============================================
echo  Baranguard AI Evaluation - Task 1/3: Case summaries
echo ============================================
echo.
echo This tests how well the AI writes short case summaries from an
echo already-redacted incident report. Nothing on this computer is sent
...
set "HAS_PROGRESS="
if exist "fixtures\eval-incidents-v1.summary.model.*.checkpoint.json" set "HAS_PROGRESS=1"
...
echo.
php scripts\ai-evaluate.php --task=summary --engine=model --limit=1 --dry-run --verbose --resume
if errorlevel 1 (
    echo.
...
echo ============================================
echo Ready to run the full 350-record case-summary test.
echo.
...
echo   evaluation-results-summary-*.txt
echo   evaluation-log-summary-*.txt
echo.
