...
echo ============================================
echo  Baranguard AI Evaluation - Task 4/7: Drafting blotter entries
echo ============================================
echo.
echo This tests how well the AI drafts a formal blotter entry without
echo leaking personal info into it. Nothing on this computer is sent
...
set "HAS_PROGRESS="
if exist "fixtures\eval-incidents-v1.blotter-assist.model.*.checkpoint.json" set "HAS_PROGRESS=1"
...
echo.
php scripts\ai-evaluate.php --task=blotter-assist --engine=model --limit=1 --dry-run --verbose --resume
if errorlevel 1 (
    echo.
...
echo ============================================
echo Ready to run the full 350-record blotter-drafting test.
echo.
...
echo   evaluation-results-blotter-assist-*.txt
echo   evaluation-log-blotter-assist-*.txt
echo.
